...
IFontDisp = Font
__all__ = [ 'IPictureDisp', 'OLE_OPTEXCLUSIVE', 'FONTITALIC',
           'OLE_HANDLE', 'OLE_COLOR', 'FONTNAME', 'StdPicture',
           'OLE_XSIZE_PIXELS', 'FontEvents', 'Font', 'Color',
           'IFontEventsDisp', 'OLE_YSIZE_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'FONTSTRIKETHROUGH',
           'OLE_YPOS_CONTAINER', 'FONTBOLD', 'Default', 'Checked',
           'OLE_XSIZE_CONTAINER', 'OLE_YSIZE_HIMETRIC',
           'FONTUNDERSCORE', 'VgaColor', 'OLE_YSIZE_PIXELS',
           'IPicture', 'IFont', 'Monochrome', 'FONTSIZE', 'IFontDisp',
           'OLE_YPOS_PIXELS', 'OLE_CANCELBOOL', 'Gray',
           'OLE_TRISTATE', 'Picture', 'OLE_XPOS_CONTAINER', 'StdFont',
           'OLE_XSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'Unchecked',
           'OLE_XPOS_PIXELS', 'OLE_YPOS_HIMETRIC',
